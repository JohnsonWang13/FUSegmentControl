...
@objc class SegmentControl: UIControl {
    ...
    private func updateView() {
        ...
        //        } else {
        //            selectorWidth = buttons[selectorSegmentIndex].titleLabel?.frame.width ?? 0
        //            selectorStartPosition = (buttons[selectorSegmentIndex].titleLabel?.frame.origin.x ?? 0) + buttons[selectorSegmentIndex].frame.origin.x
        //        }
        ...
        //        selector.backgroundColor = UIColor.btnColor
...
//                } else {
//                    selectorWidth = self.buttons[toIndex].titleLabel?.frame.width ?? 0
//                    selectorStartPosition = (self.buttons[toIndex].titleLabel?.frame.origin.x ?? 0) + self.buttons[toIndex].frame.origin.x
//                }
    ...
    func didSelected() {
        ...
        for (buttonIndex, btn) in buttons.enumerated() {
            ...
            if buttonIndex == selectorSegmentIndex {
                ...
                //                } else {
                //                    selectorWidth = btn.titleLabel?.frame.width ?? 0
                //                    selectorStartPosition = (btn.titleLabel?.frame.origin.x ?? 0) + btn.frame.origin.x
                //                }
